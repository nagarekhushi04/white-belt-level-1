 ...
 */
export default function SendForm({ publicKey, signTx, refreshBalance, setTxLoading, setTxSuccess, setTxFailed }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (setTxSuccess) setTxSuccess(result.hash)
            setRecipient('')
            setAmount('')
            setMemo('')
            ...
            if (setTxFailed) setTxFailed(parseWalletError(err).message)
        } finally {
            setIsLoading(false)
        }
    }
