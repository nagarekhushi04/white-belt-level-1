...
impl AMMPool {
    ...
    pub fn init(env: Env, factory: Address, asset_a: Address, asset_b: Address) {
    ...
    pub fn swap_a_to_b(env: Env, from: Address, amnt_in: u128) -> u128 {
        from.require_auth();
        ...
        // Ignoring fees and slippage for simplicity in Level 4 POC
