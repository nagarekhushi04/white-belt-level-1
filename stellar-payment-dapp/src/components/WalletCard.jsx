...
function BalanceDisplay({ publicKey, refreshBalance: externalRefresh }) {
    ...
    const [fundToast, setFundToast] = useState(null) // { type: 'success'|'error', message }
    ...
    return (
        <div style={{ marginTop: '20px' }}>
            ...
            {fundToast && (
                <div
                    className={
                        fundToast.type === 'success' ? 'toast-success' : 'toast-error'
                    }
 ...
 *   onConnect         – () => void
 *   onDisconnect      – () => void  (called to disconnect – passed to header slot via onDisconnectSlot)
 *   disconnectSlot    – React node — rendered into header for disconnect button
        ...
        return (
            <div className="card">
                <div style={{ textAlign: 'center', padding: '12px 0' }}>
                    ...
                    {walletError && (
                        <div className="toast-error" style={{ marginBottom: '14px', textAlign: 'left' }}>
                            <p style={{ fontSize: '0.8125rem' }}>
                                {walletError.includes('https://') ? (
                                    <>
                                        Freighter not installed. Please install it at{' '}
                                        <a
        ...
        <div className="card">
            ...
            >
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    ...
                    />
                    <span
                        style={{ fontSize: '0.8rem', color: '#8888aa', fontWeight: 500 }}
                    >
                        Connected
                    </span>
                </div>
